...
if __name__ == '__main__':
    ...
    tensor_bc = CircuitByTensor(contract_opt='greedy') #the default algorithm to contract tensor networks is 'greedy',
                                                       #you can also change to other methods.
    qser_sta = Qcover(g, p,
                      optimizer=optc,
                      backend=tensor_bc)  #qiskit_bc, qulacs_bc, pq_bc, ts_bc, and cirq_bc
